...
REM
REM Generated by Vivado on Sat May 16 05:50:42 +0530 2026
...
echo "xvlog --incr --relax -prj adder_and_sub_vlog.prj"
call xvlog  --incr --relax -prj adder_and_sub_vlog.prj -log xvlog.log
