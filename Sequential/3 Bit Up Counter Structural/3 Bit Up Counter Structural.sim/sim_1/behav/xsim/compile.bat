...
REM
REM Generated by Vivado on Mon Jun 08 06:10:26 +0530 2026
...
echo "xvlog --incr --relax -prj bit_up_counter_tb_vlog.prj"
call xvlog  --incr --relax -prj bit_up_counter_tb_vlog.prj -log xvlog.log
