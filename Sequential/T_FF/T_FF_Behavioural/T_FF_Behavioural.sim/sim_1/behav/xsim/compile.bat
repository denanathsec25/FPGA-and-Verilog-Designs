...
REM
REM Generated by Vivado on Thu Jun 04 18:03:42 +0530 2026
...
echo "xvlog --incr --relax -prj T_FF_Behavioural_tb_vlog.prj"
call xvlog  --incr --relax -prj T_FF_Behavioural_tb_vlog.prj -log xvlog.log
