...
REM
REM Generated by Vivado on Sat Jun 06 13:23:43 +0530 2026
...
echo "xvlog --incr --relax -prj mux64to1_behavioural_vlog.prj"
call xvlog  --incr --relax -prj mux64to1_behavioural_vlog.prj -log xvlog.log
