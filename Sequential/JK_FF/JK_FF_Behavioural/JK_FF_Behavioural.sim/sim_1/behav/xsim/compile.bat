...
REM
REM Generated by Vivado on Wed Jun 17 16:03:45 +0530 2026
...
echo "xvlog --incr --relax -prj JK_FF_Behavioural_tb_vlog.prj"
call xvlog  --incr --relax -prj JK_FF_Behavioural_tb_vlog.prj -log xvlog.log
