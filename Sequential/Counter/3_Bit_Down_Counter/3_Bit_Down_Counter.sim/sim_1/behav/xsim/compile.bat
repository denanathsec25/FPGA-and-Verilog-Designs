...
REM
REM Generated by Vivado on Thu Jun 18 15:15:11 +0530 2026
...
echo "xvlog --incr --relax -prj Bit_Down_tb_vlog.prj"
call xvlog  --incr --relax -prj Bit_Down_tb_vlog.prj -log xvlog.log
