...
REM
REM Generated by Vivado on Sun May 24 17:18:10 +0530 2026
...
echo "xvlog --incr --relax -prj fa_gate_tb_vlog.prj"
call xvlog  --incr --relax -prj fa_gate_tb_vlog.prj -log xvlog.log
