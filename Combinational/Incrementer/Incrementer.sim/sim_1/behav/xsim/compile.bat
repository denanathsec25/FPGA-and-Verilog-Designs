...
REM
REM Generated by Vivado on Sat May 16 11:50:45 +0530 2026
...
echo "xvlog --incr --relax -prj incrementer_vlog.prj"
call xvlog  --incr --relax -prj incrementer_vlog.prj -log xvlog.log
