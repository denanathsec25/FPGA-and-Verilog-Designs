...
REM
REM Generated by Vivado on Wed Jun 17 13:02:17 +0530 2026
...
echo "xvlog --incr --relax -prj AND_ip_wrapper_vlog.prj"
call xvlog  --incr --relax -prj AND_ip_wrapper_vlog.prj -log xvlog.log
