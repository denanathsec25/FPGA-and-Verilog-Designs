...
REM
REM Generated by Vivado on Wed Jun 17 16:27:57 +0530 2026
...
echo "xvlog --incr --relax -prj mux64to1_data_vlog.prj"
call xvlog  --incr --relax -prj mux64to1_data_vlog.prj -log xvlog.log
