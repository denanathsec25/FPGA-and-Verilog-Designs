...
synth_design -top mux64to1_data -part xc7z020clg484-1
...
write_checkpoint -force -noxdef mux64to1_data.dcp
OPTRACE "write_checkpoint" END { }
OPTRACE "synth reports" START { REPORT }
generate_parallel_reports -reports { "report_utilization -file mux64to1_data_utilization_synth.rpt -pb mux64to1_data_utilization_synth.pb"  } 
